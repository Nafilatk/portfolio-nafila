...
<div
  ref={scrollAreaRef}
  className="lg:col-span-7 h-[500px] overflow-y-auto px-4 md:px-5 lg:px-16 py-10 lg:py-20 scroll-smooth [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-track]:bg-[#1a1a1a] [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-[#991b1b] hover:[&::-webkit-scrollbar-thumb]:bg-[#b91c1c]"
  style={{
...
>
  <div ref={textRef} className="space-y-8">
    ...
    <div className="about-text h-px w-24 bg-red-600/50 my-8"></div>
